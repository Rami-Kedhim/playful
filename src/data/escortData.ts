...
// Fix import of Escort type to consistent casing; fix property names in data to match type
...
export const escortData: Escort[] = [
  {
    ...
    name: "Sofia",
    age: 25,
    gender: "female", // Add required gender property
    location: "New York",
  ...
  },
  {
    ...
    name: "Marcus",
    age: 28,
    gender: "male", // Add required gender property
