...
import { Image, Video, InfoIcon } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2">
              <Image className="h-6 w-6" /> AI Media Generator
            </h1>
            <p className="text-muted-foreground mt-1">
              Create custom AI-generated images and videos using Hugging Face models
            </p>
          </div>
        ...
        <div className="bg-amber-100 dark:bg-amber-950/50 border border-amber-200 dark:border-amber-800 px-4 py-3 rounded-lg flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-700 dark:text-amber-300 text-sm">
              This feature requires a Hugging Face API key in your Supabase project secrets.
              Generated media is processed through the Hugging Face API and may be subject to their content policies.
            </p>
          </div>
        </div>
