...
import FeaturedEscorts from '@/components/home/FeaturedEscorts';
...
const AIFeatureCard: React.FC<{ title: string, description: string, path: string }> = ({ 
  title, 
  description,
  path
}) => {
  const navigate = useNavigate();
  return (
    <div className="bg-card/50 backdrop-blur border border-border/50 rounded-xl p-6 hover:border-primary/30 hover:bg-card/80 transition-all cursor-pointer" 
