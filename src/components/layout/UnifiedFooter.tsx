...
const UnifiedFooter: React.FC<UnifiedFooterProps> = ({ 
  ...
  if (simplified) {
    return (
      <footer className={cn("border-t border-border/40 bg-background py-6", className)}>
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <Link to={AppPaths.TERMS} className="text-sm text-muted-foreground hover:text-foreground">Terms</Link>
              <Link to={AppPaths.PRIVACY} className="text-sm text-muted-foreground hover:text-foreground">Privacy</Link>
              <Link to={AppPaths.SAFETY} className="text-sm text-muted-foreground hover:text-foreground">Safety</Link>
              <Link to={AppPaths.CONTACT} className="text-sm text-muted-foreground hover:text-foreground">Contact</Link>
            </div>
          </div>
        </div>
      </footer>
    ...
    <footer className={cn("border-t border-border/40 bg-background", className)}>
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              Zero commission on transactions, UBX-powered, and fully decentralized.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={AppPaths.METAVERSE} className="text-muted-foreground hover:text-foreground transition-colors">
                  Metaverse
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={AppPaths.WALLET} className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
                  <Wallet className="h-4 w-4" /> UBX Wallet
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={AppPaths.CONTACT} className="text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
        ...
        <div className="border-t border-border mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <p className="text-sm text-muted-foreground">
              Powered by Oxum Algorithm
            </p>
            <p className="text-sm text-muted-foreground">
              <span className="text-primary font-medium">0%</span> Platform Fee
            </p>
          </div>
        </div>
      </div>
