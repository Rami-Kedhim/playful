...
const HermesBoostInfo: React.FC<HermesBoostInfoProps> = ({ 
  ...
  // If boostScore or effectivenessScore are not present, provide defaults
  const boostScore = hermesStatus.boostScore !== undefined ? hermesStatus.boostScore : 85;
  const effectivenessScore = hermesStatus.effectivenessScore !== undefined ? hermesStatus.effectivenessScore : 70;
