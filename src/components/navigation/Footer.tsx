        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              The ultimate platform for verified escorts, creators, and AI companions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/escorts" className="text-sm text-muted-foreground hover:text-foreground">Find Escorts</Link></li>
              <li><Link to="/verification" className="text-sm text-muted-foreground hover:text-foreground">Verification</Link></li>
              <li><Link to="/pulse-boost" className="text-sm text-muted-foreground hover:text-foreground">Pulse Boost</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/safety" className="text-sm text-muted-foreground hover:text-foreground">Safety Tips</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-muted-foreground">Email: support@uberescorts.com</li>
              <li className="text-sm text-muted-foreground">Hours: 24/7 Support</li>
            </ul>
          </div>
        </div>
